...
export default function ManageProductsPage({products: initialProducts, basePath = "/dashboard/user/products"}: ManageProductsPageProps) {
  ...
  const filteredProducts = products.filter(product => 
    product.fruitName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                  ...
                  <tr key={product._id} className="hover:bg-gray-50/30 transition-colors duration-150">
                    ...
                    <td className="py-4 px-6 max-w-[280px]">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <span className="font-bold text-gray-900 block truncate">{product.fruitName}</span>
                    ...
                    <td className="py-4 px-6 text-right">
                      <DeleteConfirmDialog
                        ...
                        title={`Delete "${product.fruitName}"?`}
